...
impl InputSystem {
    pub fn update_entity_from_keys(ecs: &mut ECS, entity_id: u32, pressed_keys: &HashSet<KeyCode>) {
    ...
    fn direction_from_keys(pressed_keys: &HashSet<KeyCode>, camera_yaw: Option<f32>) -> [f32; 3] {
        let mut x: f32 = 0.0;
        let mut y: f32 = 0.0;
        let mut z: f32 = 0.0;
